...
#include "constants/removed_map_local_ids.h"
...
enum
{
    ...
    OBJ_EVENT_GFX_WOODEN_GATE,
    OBJ_EVENT_GFX_WOODEN_GATE_TOP,
    OBJ_EVENT_GFX_WOODEN_GATE_BOTTOM,
    OBJ_EVENT_GFX_STONE_GATE_TOP,
    OBJ_EVENT_GFX_STONE_GATE_BOTTOM,
    OBJ_EVENT_GFX_OBSIDIAN_GATE_TOP,
    OBJ_EVENT_GFX_OBSIDIAN_GATE_BOTTOM,
    OBJ_EVENT_GFX_CRYSTAL_GATE_TOP,
    OBJ_EVENT_GFX_CRYSTAL_GATE_BOTTOM,
    NUM_OBJ_EVENT_GFX,
};
...
#define OBJ_EVENT_PAL_TAG_WOODEN_GATE             0x1134
#define OBJ_EVENT_PAL_TAG_STONE_GATE              0x1135
#define OBJ_EVENT_PAL_TAG_OBSIDIAN_GATE           0x1136
#define OBJ_EVENT_PAL_TAG_CRYSTAL_GATE            0x1137
